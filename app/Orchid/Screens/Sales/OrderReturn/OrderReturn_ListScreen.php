...
class OrderReturn_ListScreen extends Screen
{
    ...
    public function query(SalesOrder $order): iterable
    {
        ...
        $returnItems = $returns ? SalesOrderReturnItem::whereIn('order_return_id', $returns->pluck('id'))->get() : collect();
    ...
    {
        $isApprovedOrCompleted = in_array($target->status, [SalesOrder::STATUS_APPROVED, SalesOrder::STATUS_COMPLETED]);
