...
Route::screen('orders', Order_ListScreen::class)
    ...
    ->breadcrumbs(fn(Trail $trail) => $trail
        ...
        ->push(__('Sales'), route('platform.orders')));
...
// 
Route::get('orders/{order?}/pdf', [Order_ViewScreen::class, 'streamPDF'])
    ->name('platform.orders.pdf.stream');
// 
Route::get('orders/{order?}/pdfv0', [Order_ViewScreen::class, 'loadPDF'])
    ->name('platform.orders.pdf.store');
// 
...
Route::screen('order-returns', OrderReturns_ListScreen::class)
    ...
    ->breadcrumbs(fn(Trail $trail) => $trail
        ->parent('platform.orders')
        ->push(__('Sales Returns'), route('platform.orderreturns')));
...
Route::screen('order-payments', OrderPayments_ListScreen::class)
    ...
    ->breadcrumbs(fn(Trail $trail) => $trail
        ->parent('platform.orders')
        ->push(__('Sales Payments'), route('platform.orderpayments')));
