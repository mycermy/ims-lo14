    ...
    <div class="m-12">
        <table class="mb-5 w-full">
            <tbody>
                <tr>
                            ...
                            <tbody>
                                <tr class="">
                                    <td class="whitespace-nowrap pr-2 text-sm">
                                        <strong>{{ __('invoice.serial_number') }} </strong>
                                    </td>
                    ...
                    @if ($invoice->logo)
                        <td class="p-0 align-top text-end" width="30%">
                            <img src="{{ $invoice->getLogo() }}" alt="logo" width="80" height="80">
                        </td>
                    @endif
                </tr>
        ...
        <table class="mb-5 w-full">
            ...
            <tbody>
                ...
                @endforeach
                @if ($invoice->discounts || $displayTaxColumn)
                <tr>
                    {{-- empty space --}}
                ...
                @if ($invoice->tax_label || $displayTaxColumn)
                    <tr>
                        ...
                        <td class="py-2 pr-2"></td>
                        <td class="border-b p-2 text-xs" colspan="{{ $colspan }}">
                            {{ $invoice->tax_label ?? __('invoice.tax_label') }}
                        </td>
                        <td class="whitespace-nowrap border-b py-2 pl-2 text-right text-xs">
        ...
        @if ($invoice->description)
            <p class="mb-1 text-sm"><strong>{{ __('invoice.description') }}</strong></p>
